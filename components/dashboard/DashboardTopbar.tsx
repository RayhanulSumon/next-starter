...
function TopbarRight() {
  ...
  return (
    <div className="flex items-center gap-4">
      <span
        className="inline-flex items-center gap-1 rounded border border-green-200 bg-green-100 px-2 py-1 text-xs font-medium text-green-700 dark:border-green-800 dark:bg-green-900 dark:text-green-200"
        title="Online users"
      >
        <svg
